...
const int nbZones = 7; // 6 côté rue, 8-1 côté cours
int modeArrosage = 0;
int oldMode = 0;
const unsigned int sorties[8] = {33,27,14,15,32,4,21,12};
  ...
  if (theData.id==WRITING_ID) {
    switch (theData.t)
    {
      ...
      case 9: //Duree zone 8
        ...
        break;
      case 62: //Duree zone 1 2e arrosage 
        durees2[0] = theData.d;
        valeurs.putUInt("z0D2", theData.d);
        DBG(valeurs.getUInt("z0D2",0));
        break;
      case 63: //Duree zone 2 2e arrosage 
        durees2[1] = theData.d;
        valeurs.putUInt("z1D2", theData.d);
        break;
      case 64: //Duree zone 3 2e arrosage 
        durees2[2] = theData.d;
        valeurs.putUInt("z2D2", theData.d);
        break;
      case 65: //Duree zone 4 2e arrosage 
        durees2[3] = theData.d;
        valeurs.putUInt("z3D2", theData.d);
        break;
      case 66: //Duree zone 5 2e arrosage 
        durees2[4] = theData.d;
        valeurs.putUInt("z4D2", theData.d);
        break;
      case 67: //Duree zone 6 2e arrosage 
        durees2[5] = theData.d;
        valeurs.putUInt("z5D2", theData.d);
        break;
      case 68: //Duree zone 7 2e arrosage 
        durees2[6] = theData.d;
        valeurs.putUInt("z6D2", theData.d);
        break;
      case 69: //Duree zone 8 2e arrosage 
        durees2[7] = theData.d;
        valeurs.putUInt("z7D2", theData.d);
        break;
      ...
      case 11: //Décalage
        decal = theData.d;
        valeurs.putUInt("decalage", theData.d);
        break;
      case 70: //Décalage 2e arrosage 
        decal2 = theData.d;
        valeurs.putUInt("decalage2", theData.d);
        break;
    ...
    zoneGo[0] = heureDep+decal;
    zoneGo2[0] = heureDep2+decal2;
    for(int k=0;k<nbZones;k++){
...
void automatique()
{
  ...
  if (((heureAct>=zoneGo[6]) && (heureAct<zoneGo[7]))||((heureAct>=zoneGo2[6]) && (heureAct<zoneGo2[7]))){
    if (zoneEtat[6]==0) DBG("Arrosage zone 7");
    zoneEtat[6] = 1;
    zoneEtat[0] = 0;
    zoneEtat[1] = 0;
    zoneEtat[2] = 0;
...
void setup()
{
  ...
  decal = valeurs.getUInt("decalage", 0);
  decal2 = valeurs.getUInt("decalage2", 0);
...
{
  loopFDRS();
  if (millis()-chien > 120000) { // 2 minutes sans mise à jour
  ...
  /* Mode Automatique */
  if (modeArrosage==0) {
    if (((heureAct>=zoneGo[0]) && (heureAct<zoneGo[7]))||((heureAct>=zoneGo2[0]) && (heureAct<zoneGo2[7]))) automatique();
    else {
      for(int k=0; k<nbZones; k++) zoneEtat[k]=0;
    }
  }
